...
export default function AmendedAdjustmentOfAdvancesScreen() {
  ...
  const handleEdit = (item: InvoiceRecord) => {
    router.push({ pathname: "/gst/editamendedadjustmentOfadvances", params: { invoiceData: JSON.stringify(item) } });
  };
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <GSTHeader title="11B-Amended of Adjustment of Advances" />
