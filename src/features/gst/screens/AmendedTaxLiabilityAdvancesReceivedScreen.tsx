...
export default function AmendedTaxLiabilityAdvancesReceivedScreen() {
  ...
  const handleEdit = (item: InvoiceRecord) => {
    router.push({ pathname: "/gst/editamendedtaxliabilityadvances", params: { invoiceData: JSON.stringify(item) } });
  };
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <GSTHeader title="Amended Tax Liability (Advances Received)" />
