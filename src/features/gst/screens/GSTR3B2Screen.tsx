 ...
 const renderSection = (
  ...
  return (
    <View style={styles.container}>
      <GSTHeader title="GSTR 3B - 3.2 (Inter State Supplies)" />
...
const styles = StyleSheet.create({
  ...
  headerTitle:{color:"#fff",fontSize: fontSizes.md,fontWeight: fontWeights.semibold,marginLeft:8},
  desc:{fontSize: fontSizes.md,lineHeight:18,textAlign:"center",padding:14,color:"#333"},
  ...
  accText:{fontSize: fontSizes.sm,color:"#333"},
  ...
  right:{width:120},
  label:{color:"#fff",fontSize: fontSizes.sm,padding:10,borderBottomWidth:1,borderBottomColor:"#7ea4ff"},
  ...
  btnTxt:{color:"#fff",fontWeight: fontWeights.semibold},
});
