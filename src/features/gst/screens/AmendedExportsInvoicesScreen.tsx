...
export default function AmendedExportsInvoicesScreen() {
  ...
  const handleEdit = (item: InvoiceRecord) => {
    router.push({ pathname: "/gst/editamendedexportsnnvoice", params: { invoiceData: JSON.stringify(item) } });
  };
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <GSTHeader title="9A-Amended Export Invoices" />
