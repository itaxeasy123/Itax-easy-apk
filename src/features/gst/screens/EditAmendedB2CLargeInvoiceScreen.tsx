// FILE:
// app/EditAmendedB2CLargeInvoiceScreen.tsx
...
export default function EditAmendedB2CLargeInvoiceScreen() {
  ...
  const handleSave = () => {
    ...
    router.push({
      pathname:
        "/gst/amended-b2c-large-invoices",
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: "#f0f2f5"}}>
      <View style={styles.container}>
        <GSTHeader title="9A-Amended B2C (Large)" />
