...
import { useB2BStore, RecordItem } from "../../../store/b2bStore";
import {
  View,
  Text,
  TouchableOpacity,
            ...
            <View style={styles.tableContainer}>
              <View style={styles.tableWrapper}>
                ...
                <View style={styles.headerRow}>
                  ...
                  {viewMode === "primary" ? (
                    <>
                      <Text style={[styles.headerCell, { flex: 2 }]}>GSTIN</Text>
                      <Text style={[styles.headerCell, { flex: 1 }]}>POS</Text>
                      <Text style={[styles.headerCell, { flex: 1.2 }]}>Supply</Text>
                      <Text style={[styles.headerCell, { flex: 1.5 }]}>Invoice No.</Text>
                  ...
                  >
                    ...
                    {viewMode === "primary" ? (
                      <>
                        ...
                        <Text style={[styles.dataCell, { flex: 1 }]} numberOfLines={1}>{item.state || "-"}</Text>
                        <Text style={[styles.dataCell, { flex: 1.2 }]} numberOfLines={1}>{item.supplyType || "-"}</Text>
                        <Text style={[styles.dataCell, { flex: 1.5 }]} numberOfLines={1}>{item.invoiceNo || "-"}</Text>
                        <Text style={[styles.dataCell, { flex: 1.5 }]} numberOfLines={1}>{item.invoiceDate || "-"}</Text>
                        <Text style={[styles.dataCell, { flex: 1.5, fontWeight: fontWeights.bold }]} numberOfLines={1}>
                      ...
                      <>
                        ...
                        <Text style={[styles.dataCell, { flex: 1.2 }]} numberOfLines={1}>{item.integrated || "0"}</Text>
          ...
          {selectedRecord && (
            ...
            >
              <View style={styles.bottomSheet} onStartShouldSetResponder={() => true}>
                ...
                <Text style={styles.popupTitle}>Options for {selectedRecord.invoiceNo || "Record"}</Text>
