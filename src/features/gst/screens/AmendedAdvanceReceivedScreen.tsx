...
export default function AmendedAdvanceReceivedScreen() {
  ...
  const handleEdit = (item: InvoiceRecord) => {
    router.push({ pathname: "/gst/editamendedadvancereceived", params: { invoiceData: JSON.stringify(item) } });
  };
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <GSTHeader title="11A-Amended Tax Liability (Advanced Received)" />
