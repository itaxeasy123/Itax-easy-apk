...
export default function AmendedB2BOthersScreen() {
  ...
  const handleEdit = (item: InvoiceRecord) => {
    router.push({ pathname: "/gst/editamendedb2bother", params: { invoiceData: JSON.stringify(item) } });
  };
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <GSTHeader title="Amended B2B (Others)" />
