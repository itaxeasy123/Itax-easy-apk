// FILE:
// app/EditAmendedAdjustmentOfAdvancesScreen.tsx
...
export default function EditAmendedAdjustmentOfAdvancesScreen() {
  ...
  const handleSave = () => {
    ...
    router.push({
      pathname:
        "/gst/amended-adjustment-of-advances",
  ...
  return (
    <SafeAreaView style={{flex: 1, backgroundColor: "#f0f2f5"}}>
      <View style={styles.container}>
        <GSTHeader title="11B-Amended Adjustment of Advances" />
