...
import { useCDNRStore, RecordItem } from "../../../store/cdnrStore";
import {
  View,
  Text,
  TouchableOpacity,
                ...
                <View style={styles.headerRow}>
                  ...
                  {viewMode === "primary" ? (
                    <>
                      ...
                      <Text style={[styles.headerCell, { flex: 1.5 }]}>Recipient</Text>
                      <Text style={[styles.headerCell, { flex: 1 }]}>Note No.</Text>
                      <Text style={[styles.headerCell, { flex: 1 }]}>Note Date</Text>
                      <Text style={[styles.headerCell, { flex: 1 }]}>Note Type</Text>
                      <Text style={[styles.headerCell, { flex: 1 }]}>POS</Text>
                      <Text style={[styles.headerCell, { flex: 1.5 }]}>Note Val</Text>
                      <Text style={[styles.headerCell, { width: 80, textAlign: 'center' }]}>Actions</Text>
                    </>
                  ) : (
                    <>
                      <Text style={[styles.headerCell, { flex: 1.5 }]}>Supply Type</Text>
                  ...
                  >
                    ...
                    {viewMode === "primary" ? (
                      <>
                        ...
                        <Text style={[styles.dataCell, { flex: 1.5 }]} numberOfLines={1}>{item.recipientName || "-"}</Text>
                        <Text style={[styles.dataCell, { flex: 1 }]} numberOfLines={1}>{item.noteNo || "-"}</Text>
                        <Text style={[styles.dataCell, { flex: 1 }]} numberOfLines={1}>{item.noteDate || "-"}</Text>
                        <Text style={[styles.dataCell, { flex: 1 }]} numberOfLines={1}>{item.noteType || "-"}</Text>
                        <Text style={[styles.dataCell, { flex: 1 }]} numberOfLines={1}>{item.place || item.state || "-"}</Text>
                      ...
                      <>
                        <Text style={[styles.dataCell, { flex: 1.5 }]} numberOfLines={1}>{item.supplyTypeInput || "-"}</Text>
