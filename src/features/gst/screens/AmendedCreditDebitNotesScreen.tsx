...
export default function AmendedCreditDebitNotesScreen() {
  ...
  const handleEdit = (item: InvoiceRecord) => {
    router.push({ pathname: "/gst/editamendedcreditdebitnotes", params: { invoiceData: JSON.stringify(item) } });
  };
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <GSTHeader title="9A-Amended Credit/Debit Notes (Registered)" />
