...
const getRowsById = (id: number): DetailRow[] => {
  switch (id) {
    ...
    case 2:
      return [
        { id: 1, label: "Nil Rated Supplies", value: "0.0" },
        { id: 2, label: "Exempted Supplies", value: "0.0" },
        { id: 3, label: "Total Value", value: "0.0" },
      ];

    case 3:
      return [
        { id: 1, label: "Non GST Supplies", value: "0.0" },
        { id: 2, label: "Exempt Supplies", value: "0.0" },
        { id: 3, label: "Total Value", value: "0.0" },
      ];
