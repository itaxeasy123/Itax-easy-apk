...
import { useB2CLargeStore, RecordItem } from "../../../store/b2cLargeStore";
import {
  View,
  Text,
  TouchableOpacity,
                ...
                <View style={styles.headerRow}>
                  ...
                  {viewMode === "primary" ? (
                    <>
                      ...
                      <Text style={[styles.headerCell, { flex: 1.5 }]}>Supply</Text>
                  ...
                  >
                    ...
                    {viewMode === "primary" ? (
                      <>
                        ...
                        <Text style={[styles.dataCell, { flex: 1.5 }]} numberOfLines={1}>{item.supplyType1 || "-"}</Text>
                        ...
                        <Text style={[styles.dataCell, { flex: 1.5, fontWeight: fontWeights.bold }]} numberOfLines={1}>{item.totalInvoiceValue || "0"}</Text>
